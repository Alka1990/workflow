...
public class ThreeDPrintingVo {
  ...
  public String getPrinting_id() {
    return this.printing_id;
  }
  
  public void setPrinting_id(String printing_id) {
    this.printing_id = printing_id;
  }
