...
@WebServlet({ "/drafttosubmit" })
public class drafttosubmit extends HttpServlet {
  static final Logger LOGGER = LogManager.getLogger(drafttosubmit.class);

  public drafttosubmit() {
  }
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    try {
      ...
      ProfileVO profileVO = LoginDAO.ProfileMapping(user_id, decision, "Intro", 0L);
      Statement insertStmnt = con.createStatement();
      Statement insertStmnt1 = con.createStatement();
      String query4 = "update patient_details set USER_ID='" + user_id + "',initiated_by='" + user_id
          ...
          + "',pickup='" + pickup + "',dispatch='" + dispatch + "',dispatch_to='" + dispatch_to + "',advance_starter='"
          + advance_starter + "',advance_scanning='" + advance_scanning + "', scanning_service='" + scanning_service
          + "',dispatch_date='" + dispatch_date + "',person_dispatch='" + person_dispatch + "',person_scan='"
          + person_scan + "',bill_to='" + bill_to + "',gst_number='" + gst_number + "',payment_mode='" + payment_mode
          + "',wo_number='" + wo_number + "',wo_date='" + wo_date + "',priority='" + priority
          + "',created_date=sysdate(),no_of_stages='" + no_of_stages + "',current_stage= '" + current_stage
          + "',no_of_aligners_u_a='" + no_of_aligners_u_a + "',no_of_aligners_u_p='" + no_of_aligners_u_p
          + "',no_of_aligners_l_a='" + no_of_aligners_l_a + "',no_of_aligners_l_p= '" + no_of_aligners_l_p
          + "',attachment_applicable='" + attachment_applicable + "',dispatch_grid='" + dispatch_grid + "',data_grid='"
          + data_grid + "',dispatch_date2='" + dispatch_date2 + "',final_amount='" + final_amount + "',status_grid='"
          + status_grid + "',payment_grid='" + payment_grid + "',batch_number='" + batch_number + "',work_date='"
          + work_date + "',next_work='" + next_work + "',next_work_date='" + next_work_date + "',case_review='"
          + case_review + "',refinement_package='" + refinement_package + "',draftflag='N'  where case_id='" + caseId
          + "'";
      ...
      query3 = query3.replace("<userid>", user_id);
      ...
      query4 = "Insert into Decision_History(decision,Remarks,date_time,stage, UserId,caseid) values( '" + decision
          + "','" + remarks + "', sysdate(),'Intro','" + user_id + "','" + case_id + "') ";
      insertStmnt1.executeUpdate(query4);
      String query2 = "";
      ...
      LOGGER.info("Error At AddComment=" + var88.getMessage());
    }
