							...
							<div class="col-lg-12">
								<table id="dtBasicExample"
									...
									<tbody>
										...
										%>
										<tr>
											<td><a href="Approval?caseId=<%=searchvo.getCase_Id()%>&logusername=<%=request.getAttribute("username")%>&NxtStage=<%=searchvo.getBatch_stage()%>&SearchStage=Y"><%=searchvo.getCase_Id()%></a></td>
