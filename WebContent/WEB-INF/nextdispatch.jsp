...
<form name="MyInvoiceForm" id="MyInvoiceForm" method="post" action="${pageContext.request.contextPath}/Findnextdispatchdate" target="_self" >
...
<div class="container" style="padding-top:20px;">
  <div class="panel panel-primary">
    <div class="panel-heading"><strong>Find Next Dispatch Date</strong> </div>
...
<span style="color:red" class="required">*</span></label>
     <span style=" padding-left:152px;;margin-top:5px;">             					
       ...
       <tr>
         ...
         <input class="form-control" type="date" name="fromdate" /></td>   
 	   <td  width="50%"> To Date : 
			 <input class="form-control"  type="date" name="todate" /></td>   
